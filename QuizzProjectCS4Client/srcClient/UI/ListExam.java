...
public class ListExam extends javax.swing.JPanel {
    ...
    private void loadDataExam() {
        try {
            ...
            ArrayList<DTO.ExamDTO> res = bllEx.getListUserExam();
            insertHeaderExam();
    ...
    private void initComponents() {
        ...
        btnCreateExam.setIcon(new ImageIcon(ListExam.class.getResource("/img/plus.png")));
        btnUpdateExam = new javax.swing.JButton();
        btnUpdateExam.setIcon(new ImageIcon(ListExam.class.getResource("/img/refresh.png")));
        btnDeleteExam = new javax.swing.JButton();
        btnDeleteExam.setIcon(new ImageIcon(ListExam.class.getResource("/img/delete.png")));
        ...
        btnOpenPanelCreateQuestion.setIcon(new ImageIcon(ListExam.class.getResource("/img/plus.png")));
        pInput6 = new javax.swing.JPanel();
        jScrollPane2 = new javax.swing.JScrollPane();
        tbQuestion = new javax.swing.JTable();
        jLabel8 = new javax.swing.JLabel();
        btnUpdateQuestion = new javax.swing.JButton();
        btnUpdateQuestion.setIcon(new ImageIcon(ListExam.class.getResource("/img/refresh.png")));
        ...
        btnCreateExam.setForeground(new Color(0, 255, 64));
        ...
        btnDeleteExam.setForeground(new Color(255, 0, 0));
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        					.addComponent(btnDeleteExam, GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        					.addGap(22))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false)
        						.addComponent(btnCreateExam, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        						.addComponent(btnUpdateExam, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        					.addContainerGap(18, Short.MAX_VALUE))))
        );
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addComponent(btnCreateExam, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnUpdateExam, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnDeleteExam, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap(18, Short.MAX_VALUE))
        );
        ...
        btnOpenPanelCreateQuestion.setForeground(new Color(0, 255, 255));
        ...
        pInput5Layout.setHorizontalGroup(
        	pInput5Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(pInput5Layout.createSequentialGroup()
        			.addGap(16)
        			.addComponent(jLabel9)
        			.addPreferredGap(ComponentPlacement.RELATED, 112, Short.MAX_VALUE)
        			.addComponent(btnOpenPanelCreateQuestion)
        			.addGap(0, 114, Short.MAX_VALUE))
        		.addGroup(pInput5Layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 535, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        pInput5Layout.setVerticalGroup(
        	pInput5Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(pInput5Layout.createSequentialGroup()
        			.addGroup(pInput5Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel9)
        				.addComponent(btnOpenPanelCreateQuestion, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE))
        ...
        btnUpdateQuestion.setForeground(new Color(0, 0, 0));
        ...
        pInput6Layout.setHorizontalGroup(
        	pInput6Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(pInput6Layout.createSequentialGroup()
        			.addGap(0)
        			.addGroup(pInput6Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 624, GroupLayout.PREFERRED_SIZE)
        				.addGroup(pInput6Layout.createSequentialGroup()
        ...
        pInput6Layout.setVerticalGroup(
        	pInput6Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(pInput6Layout.createSequentialGroup()
        			.addGroup(pInput6Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel8)
        				.addComponent(btnUpdateQuestion, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(pInput5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(pInput6, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        		.addComponent(HEADER, GroupLayout.DEFAULT_SIZE, 1237, Short.MAX_VALUE)
        		.addGroup(layout.createSequentialGroup()
        			.addComponent(pInput4, GroupLayout.PREFERRED_SIZE, 1164, GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(pInput4, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(jSeparator1, GroupLayout.PREFERRED_SIZE, 3, GroupLayout.PREFERRED_SIZE)
        			.addGap(20)
        			.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        				.addComponent(pInput5, 0, 0, Short.MAX_VALUE)
        				.addComponent(pInput6, GroupLayout.PREFERRED_SIZE, 473, Short.MAX_VALUE))
